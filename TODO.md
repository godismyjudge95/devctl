...
- update readme with browser notification functionality
- add spx profile functionality similar to dumps or mail - fully integrated - ask any and all questions if you are unsure how to implement something with this
